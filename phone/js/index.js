$(function(){
    ...
    function createBlogHtml(Data){
        ...
        for(var i=0;i<data.length;i++){
            ...
            htm+='<div class="swiper-slide" dataid="'+[data[i].Id]+'">'+
        ...
        $('.swiper-container1 .swiper-wrapper').empty().append(htm);
        swiperStart();

    }

    $('.swiper-container1').on('click','.swiper-slide',function(){
    ...
    //资深咨询师专区
    $('.info-link .link-item').on('click',function(){
    ...
    function _addClass(index){
        ...
        link.eq(index).animate({right:5,padding:0},200);
        link.eq(index).siblings().animate({right:0,padding:2},200);
